            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="md:flex md:justify-around">
                        ...
                        <div class="mb-4 text-center"><button type="button" data-micromodal-trigger="modal-1" href="javascript:;" class="text-white bg-red-400 border-0 py-2 px-6 focus:outline-none hover:bg-red-500 rounded">ショップの詳細を見る</button></div>
                    </div>
                </div>
            </div>
        </div>
